...
// AFÍNALO AQUÍ tras ver la impresión física: 1.40 = +40% (subir para más
// grande, bajar para más chico). Solo afecta a las fuentes; el padding, el
// borde y el código de barras no dependen de esto.
